...
class UserEnrolmentProgram extends Model
{
  ...
  ORDER BY completed_count desc');
    ...
    public function getEnrolmentByOrg($org) {
        ...
        $builder->select('concat(first_name,\' \',last_name) as name, email, master_user.org_name, designation, course_name, user_enrolment_course.status, completion_percentage, completed_on');
